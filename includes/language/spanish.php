...
global $LANG;
$LANG = array (
    'settings_default_session_expiration_time' => 'Tiempo por defecto para la expiración de la sesión.',
    'settings_ldap_user_attribute' => 'Atributo de usuario para la búsqueda',
    'settings_ldap_user_attribute_tip' => 'Atributo LDAP para la búsqueda del usuario',
    ...
    'email_ga_subject' => 'Tu Código Flash Google para Teampass',
    'email_ga_text' => 'Hola,<br><br>Por favor, pulsa este <a href=\'#link#\'>ENLACE</a> y escanea con tu aplicación de Google para la autentificación para obtener tus credenciales OTP para Teampass.<br /><br />Gracias',
    'settings_attachments_encryption' => 'Habilitar cifrado de los items adjuntos',
    'settings_attachments_encryption_tip' => 'ESTA OPCIÓN PUEDE ROMPER LOS ADJUNTOS EXISTENTES, por favor lee con cuidado lo siguiente. Si se habilita, los archivos se guardarán cifrados en el servidor. La encriptación usa el SALT definido en Teampass. Este cifrado consumira más recursos del servidor. ADVERTENCIA: una vez activado, es necesario ejecutar el script para adaptar los ficheros existentes. Ver pestaña \'Acciones Específicas\'.',
    'admin_action_attachments_cryption' => 'Cifrar o descifrar los Items adjuntos',
    ...
    'category_in_folders' => 'Editar Carpetas para esta Categoria',
    'select_folders_for_category' => 'Selecciona las Carpetas a asociar a esta Categoría',
    'offline_mode_warning' => 'El modo Off-line permitira exportar los objetos en un fichero HTML, así podrás acceder a ellos sin estar conectado al servidor de Teampass. Las constraseñas estarán cifradas con la clave que proporciones en el proceso.',
    ...
    'offline_mode_key_level' => 'Mínimo nivel de encriptación para el modo Off-line',
    'categories' => 'Categorías',
    'new_category_label' => 'Crear nueva Categoría - Añadir etiqueta',
    'no_category_defined' => 'Categoría no definida',
    'confirm_deletion' => 'Va a eliminar, ¿está seguro?',
    'confirm_rename' => 'Confirmar renombrado?',
    'new_field_title' => 'Intruduzca el título del nuevo campo',
    'confirm_creation' => 'Confirmar creación?',
    'confirm_moveto' => 'Confirmar movimiento del campo?',
    'for_selected_items' => 'Para los objetos seleccionados',
    'move' => 'Mover a',
    'field_add_in_category' => 'Añadir un nuevo campo a esta categoría',
    'rename' => 'Renombrar',
    'settings_item_extra_fields' => 'Autorizar los objetos para completar con más campos (por categorías)',
    ...
    'html' => 'html',
    'more' => 'Más',
    'save_categories_position' => 'Salvar el orden de las Categorías',
    ...
    'settings_tree_counters' => 'Mostrar más contadores en el árbol de carpetas',
    ...
    'settings_encryptClientServer' => 'Intercambio entre Cliente Servidor es cifrado',
    ...
    'error_group_noparent' => 'No has selecionado padre!',
    'channel_encryption_no_iconv' => 'Extension ICONV no esta cargada! La encriptación no puede ser iniciada!',
    'channel_encryption_no_bcmath' => 'Extension BCMATH no esta cargada! La encriptación no puede ser iniciada!',
    ...
    'enable_personal_folder_feature_tip' => 'Una vez activado, es necesario que ejecutes de forma manual el script que creará las carpetas personales para los usuarios existentes. Este script creará las carpetas solo de los usuairos que no la tuvieran anteriormente. El script \'".$txt[\'admin_action_check_pf\']."\' esta disponible en la pestaña \'".$txt[\'admin_actions_title\']."\'',
    ...
    'user_profile_dialogbox_menu' => 'Tu pérfil de Teampass',
    'admin_email_security' => 'seguridad SMTP',
    'alert_page_will_reload' => 'La página será recargada',
    'csv_import_items_selection' => 'Seleciona los objetos para importar',
    'csv_import_options' => 'Seleciona las opciones de importación',
    'file_protection_password' => 'Define la contraseña del fichero',
    'button_export_file' => 'Exportar objetos',
    'error_export_format_not_selected' => 'Selecciona un formato para el fichero de exportación',
    'select_file_format' => 'Seleciona el formato del fichero',
    'button_offline_generate' => 'Generar el archivo para el modo Offline',
    'upload_new_avatar' => 'Seleciona el archivo PNG para el avatar',
    'expand' => 'Expandir',
    'collapse' => 'Colapsar',
    'error_file_is_missing' => 'Error: El Archivo esta perdido!',
    'click_to_change' => 'Pulsa para cambiar',
    '' => ''
);
