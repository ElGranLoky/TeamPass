...
global $LANG;
$LANG = array (
    'settings_roles_allowed_to_print' => 'Defina los roles con permiso de impresión',
    'settings_roles_allowed_to_print_tip' => 'Los roles seleccionados podrán imprimir los elementos a un archivo.',
    'user_ga_code' => 'Enviar el código de Google al usuario por email',
    'send_ga_code' => 'Código de Google para el usuario',
    'error_no_email' => 'Este usuario no tiene email!',
    'error_no_user' => 'No se encontró el usuario!',
    'email_ga_subject' => 'Tu código flash de Google para Teampass',
    'email_ga_text' => 'Hola,<br><br>Por favor pulsa aquí <a href=\'#link#\'>LINK</a> y entra con tu código flash de Google, para recibir tu credencial OTP para Teampass.<br /><br />Gracias',
    'settings_attachments_encryption' => 'Habilitar cifrado de los Items adjuntos',
    'settings_attachments_encryption_tip' => 'ESTA OPCIÓN PODRÍA ROMPER LOS ADJUNTOS EXISTENTES, por favor presta atención. Si se habilita, los adjuntos serán guardados cifrados en el servidor. La encriptación usa el SALT definido en Teampass. Esto requiere más recursos del servidor. ATENCION: una vez activado, es necesario ejecutar el script para adaptar los adjuntos existentes. Mira la pestaña \'Specific Actions\'.',
    'admin_action_attachments_cryption' => 'Cifrar o descifrar los Items adjuntos',
    'admin_action_attachments_cryption_tip' => 'ATENCIÓN: esta acción se realizará SOLAMENTE después de cambiar la opción asocida en las opciones de Teampass. Por favor, ház una copia de la carpeta \'upload\' antes de realizar la acción, por si las moscas ...',
    'encrypt' => 'Cifrar',
    'decrypt' => 'Descifrar',
    'admin_ga_website_name' => 'Nonmbre mostrado en la autentificación de Google para Teampass',
    'admin_ga_website_name_tip' => 'Este nombre es usado para el código de identificación en Google.',
    'admin_action_pw_prefix_correct' => 'Corregir los prefijos de claves',
    'admin_action_pw_prefix_correct_tip' => 'Antes de ejecutar este script, POR FAVOR ház un backup de la base de datos. Este proceso realizará una actualización del prefijo de las contraseñas. DEBERÍA de ser usado solamente si ves unos prefijos incorrectos en las claves.',
    'items_changed' => 'ha sido cambiado.',
    'ga_not_yet_synchronized' => 'Identificaté con el Autentificador de Google',
